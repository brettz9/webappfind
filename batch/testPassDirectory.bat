...
:: e.g., the location, C:\Users\Brett\AppData\Roaming\Microsoft\Windows\SendTo
"c:\Program Files (x86)\Mozilla Firefox\firefox.exe" -webappdir "%1" -webappsite "http://brett-zamir.me/webappfind/demos/dir.html?path=%path"
