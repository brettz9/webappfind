    ...
    registerComponent({
        ...
        handler: function clh_handle(cmdLine) {
            ...
            try {
                ...
                handleError('WebAppFind expects one of the following fundamental modes to be passed to ' + modeCommandName + ': ' + standardModes.join(', ') + '; ' + (mode ? '"' + mode + '" was supplied' : 'no mode was found') + '.');
                return;
            }
