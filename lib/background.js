...
browser.contextMenus.create({
    id: 'atyourcommand',
    title: _('atyourcommand-open-oneoff'),
    contexts: ['page']
});
/*
// Todo: Put this into default storage
browser.contextMenus.create({
    id: 'atyourcommand-open-in-waf-edit',
    title: _('Open in WebAppFind edit mode'),
    contexts: ['page']
});
// Todo: invite (or utilize?) sharing of i18n with AppLauncher
browser.contextMenus.create({
    id: 'atyourcommand-one-off',
    title: _('Create a one-off command'),
    contexts: ['all']
});
browser.contextMenus.create({
    id: 'atyourcommand-commands',
    title: _('Edit commands')
});
browser.contextMenus.create({
