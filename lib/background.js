...
async function updateContextMenus () {
    await Promise.all([
        ...
        */
        ...
        ['asyouwish', 'enable-asyouwish'],
        ['atyourcommand', 'atyourcommand-open-oneoff', {
            contexts: ['page']
        }],
        ['atyourcommand-one-off', 'Create a one-off command'],
        ['atyourcommand-commands', 'Edit commands'],
        ['atyourcommand-prefs', 'Open preferences']
...
browser.contextMenus.onClicked.addListener(async (info, tab) => {
    ...
    if (menuItemId.startsWith('atyourcommand')) {
        ...
        let titlePreface = _('atyourcommand-window-title');
        ...
        const selector = 'body'; // Todo: Let user define
        setSelectorContext({menuItemId, selector, updateContextMenus});
        const {
            selectionText,
            linkText, linkUrl,
