...
1. Abstract the message listening and posting into a simpler utility class to reduce demo code (and allow better forward compatibility with any API changes).
