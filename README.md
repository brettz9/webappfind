...
1. Extra tabs still opening on occasion, providing fundamental mode error?
...
1. "Todo" webapp demo
1. CoffeeScript demo
1. Modify the OCR demo to support detection (by WebAppFind-injected URL params) of various image formats, SVG, canvas (or even [HTML-to](http://robert.ocallahan.org/2011/11/drawing-dom-content-to-canvas.html)[-canvas](http://people.mozilla.org/~roc/rendering-HTML-elements-to-canvas.html)?) images to OCR
